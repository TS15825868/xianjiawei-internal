...
replaceRegex('src/publishing-content-audit-entry.js',
  /async function batchAudit\(request,env,ctx\)\{[\s\S]*?return json\(\{version:VERSION,total:items\.length,problem_count:items\.filter\(item=>!item\.ok\)\.length,items\}\);\}/,
