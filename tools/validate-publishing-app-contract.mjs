...
const requiredHtml=['貼文審核發佈系統','data-refresh','data-diagnose','data-add-post','searchInput','statusFilter','clearFilters','listRoot','modalRoot','toastRoot','readinessSummary','publishing-performance.css','publishing-resilience.js','publishing-readiness-ui.js','publishing-app-v2.js','publishing-review-gate.js','post-bank-sync.js','post-regenerate-buttons.js','post-regenerate-policy-v1.js','manual-publish-tools.js','20260810-standalone-v16-latest-product-photos','publishing-app-v2.js?v=20260810-publishing-v16-latest-product-photos'];
...
for(const token of [
  "FAST_API_VERSION='2026-08-09-fast-read-v1-shared-access'",
...
console.log('PASS：v16獨立貼文系統先完成核心安全診斷再載入資料；立即發布不受固定時段限制，並具備單一重生成流程、500篇同步、快速Access驗證、D1安全模式、平台API預檢、server pagination、離線快取、LINE keep-warm與逐平台發布結果。');
