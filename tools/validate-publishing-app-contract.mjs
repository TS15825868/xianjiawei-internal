...
const requiredHtml=['貼文審核發佈系統','data-refresh','data-diagnose','data-add-post','searchInput','statusFilter','clearFilters','listRoot','modalRoot','toastRoot','readinessSummary','publishing-performance.css','publishing-resilience.js','publishing-readiness-ui.js','publishing-app-v2.js','publishing-review-gate.js','post-regenerate-v6.js','manual-publish-tools.js','standalone-v13-cohesive-readiness'];
...
console.log('PASS：獨立貼文系統具備快速Access驗證、D1安全模式、平台API預檢、分層健康診斷、server pagination、離線快取、LINE keep-warm，以及官方API/Webhook/人工fallback與逐平台發布結果。');
