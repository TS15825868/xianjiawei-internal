...
const CONFIG=Object.freeze({
  runtime:'formal-media-policy-20260812-trial-master-v2',
  approvalBatch:'20260812-user-approved-customer-display',
  productAuthority:'products-v3-real-product-identity-authority',
  displayPolicy:'產品／試喝貼文優先使用使用者最新核准正式DM／正式視覺；龜鹿飲試喝整張主圖固定作試喝圖，也作30cc正式顧客視覺來源與180cc右下鋁袋視覺來源；products-v3只作實物外觀、包裝與比例校正，不再要求顧客端使用簡單原圖。',
  ...
  formalProductMedia:Object.freeze([
    Object.freeze({id:'trial',keywords:['試喝','3罐免費','試喝組','先試喝'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/trial.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'fixed-full-trial-master',alt:'龜鹿飲試喝組｜先試喝，再決定'}),
    Object.freeze({id:'guilu-gao',keywords:['龜鹿膏'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/guilu-gao.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'own-formal-dm',alt:'仙加味龜鹿膏100g正式DM'}),
    Object.freeze({id:'guilu-drink-30',keywords:['龜鹿飲30cc','30cc','小玻璃罐'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/guilu-drink-30cc.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'trial-master-30cc-or-three-jar-area',alt:'仙加味龜鹿飲30cc／罐（小玻璃罐）正式主視覺',validation:'actual-small-glass-jar-no-label-gold-lid-no-shape-or-proportion-change'}),
    Object.freeze({id:'guilu-drink-180',keywords:['龜鹿飲180cc','180cc','鋁袋'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/guilu-drink-180cc.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'trial-master-lower-right-180cc-foil-pouch-area',alt:'仙加味龜鹿飲180cc鋁袋正式主視覺',validation:'actual-foil-pouch-no-shape-or-proportion-change'}),
    Object.freeze({id:'guilu-tangkuai',keywords:['龜鹿湯塊','湯塊75g','湯塊'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/guilu-tangkuai.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'own-formal-dm',alt:'仙加味龜鹿湯塊75g／盒｜8塊裝正式DM'}),
    Object.freeze({id:'guilu-jiao',keywords:['龜鹿膠','600g','32塊'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/guilu-jiao.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'own-formal-dm',alt:'仙加味龜鹿膠600g／盒｜32塊裝正式DM'}),
    Object.freeze({id:'luerong-fen',keywords:['鹿茸粉','鹿茸','75g'],public_url:'https://ts15825868.github.io/xianjiawei/images/customer-display-v20260812/luerong-fen.webp?v=20260812',binary_ready:true,approved:true,source:'user-approved-formal-media-v20260812',role:'own-formal-dm',alt:'仙加味鹿茸粉75g正式DM'})
  ]),
  ...
  hardReject:Object.freeze(['products-v2','products-v4-final-as-customer-main','ai-redrawn-wrong-product','wrong-30cc-container','wrong-180cc-package','collage','cropped-character','stretched-product','copy-image-mismatch','dm-copy-conflict','retired-piece-weight','retired-jin-wording'])
});
