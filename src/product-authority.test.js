...
assert.equal(PRODUCT_AUTHORITY.soupBlockOnly,'75g／盒｜8塊裝｜每塊約9.375g');
...
const validProducts=[
  ...
  {name:'龜鹿湯塊',specification:'75g／盒｜8塊裝｜每塊約9.375g',ingredients:'龜板萃取物、鹿角萃取物'},
  {name:'龜鹿膠',specification:'600g（1斤）／盒｜32塊裝｜每塊約18.75g',ingredients:'龜板萃取物、鹿角萃取物'},
...
]) assert.ok(validateProductRecord(stale).length>0,`舊縮短規格應拒絕：${stale.name} ${stale.specification}`);
...
console.log('PASS ERP六項完整正式產品規格、正式成分、龜鹿膏使用方式、湯塊75g與貼文圖文產品匹配守門');
