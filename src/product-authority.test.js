...
assert.deepEqual(validateProductRecord({name:'龜鹿膏',specification:'100g／罐',usage:'每日早上及下午各一小匙'}),[]);
...
assert.deepEqual(validatePublicProductText('龜鹿膏每日早上及下午各一小匙'),[]);
...
console.log('PASS 目前六項正式主規格、正式成分、龜鹿膏每日早上及下午各一小匙、龜鹿膠1斤規格與圖文產品匹配；detail-only重量、30cc舊瓶稱、退役媒體與舊龜鹿膏用法仍拒絕，跨產品規格不再誤判。');
