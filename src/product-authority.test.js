...
assert.equal(PRODUCT_AUTHORITY.sourceAuthority,'xianjiawei-product-ssot');
assert.match(PRODUCT_AUTHORITY.version,/20260817-product-ssot-v1/);
...
console.log('PASS 唯一產品母資料已套用：六項正式名稱／規格／成分與個人作息使用原則一致，ERP 不再自行維護第二份核心規格。');
