...
assert.equal(PRODUCT_AUTHORITY.guiluGaoUsagePrimary,'食用時間與份量可依個人使用習慣與作息安排');
assert.equal(PRODUCT_AUTHORITY.guiluDrink30UsagePrimary,'每日 1-2罐；飲用時間可依個人使用習慣與作息安排');
assert.equal(PRODUCT_AUTHORITY.guiluDrink180UsagePrimary,'每日一包；飲用時間可依個人使用習慣與作息安排');
...
const validProducts=[
  {name:'龜鹿膏',specification:'100g／罐',ingredients:'鹿角萃取物、龜板萃取物、枸杞、紅棗、黃耆、粉光蔘',usage:'食用時間與份量可依個人使用習慣與作息安排；初次可先從半匙開始'},
...
assert.deepEqual(validateProductRecord({name:'龜鹿膏',specification:'100g／罐',usage:'食用時間與份量可依個人使用習慣與作息安排'}),[]);
...
assert.deepEqual(validatePublicProductText('龜鹿膏食用時間與份量可依個人使用習慣與作息安排'),[]);
...
assert.deepEqual(validatePublicProductText('龜鹿飲30cc玻璃罐每日 1-2罐；飲用時間可依個人使用習慣與作息安排'),[]);
assert.ok(validatePublicProductText('龜鹿飲30cc玻璃罐每日一罐').length>0);
assert.ok(validatePublicProductText('龜鹿飲30cc玻璃罐建議白天飲用').length>0);
assert.deepEqual(validatePublicProductText('龜鹿飲180cc鋁袋每日一包；飲用時間可依個人使用習慣與作息安排'),[]);
